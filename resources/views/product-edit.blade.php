...
<div class="page">
    ...
    <div class="page-sub">Update this menu item</div>
    ...
    <div class="card">
        <form method="POST" action="/products/{{ $product->product_id }}" id="product-form">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="field-group field-group-0">
                        ...
                        <select name="temperature" id="temperature" class="field-select select-full" required>
                            ...
                            <option value="COLD" {{ old('temperature', $product->temperature) === 'COLD' ? 'selected' : '' }}>🧊 Cold</option>
                        </select>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div id="ingredient-list">
                        @foreach($ingredients as $ingredient)
                            @php
                                $linked = $productIngredients->firstWhere('ingredient_id', $ingredient->ingredient_id);
                            @endphp
                        <div class="menu-item ing-row">
                            ...
                            <div id="qty-wrap-{{ $ingredient->ingredient_id }}"
                                 class="{{ $linked ? 'ing-qty-wrap' : 'ing-qty-hidden' }}">
                                <input type="number"
                                       name="ingredients[{{ $ingredient->ingredient_id }}][quantity_used]"
                                       id="qty-{{ $ingredient->ingredient_id }}"
                                       min="1"
                                       value="{{ $linked->quantity_used ?? 1 }}"
                                       class="ing-qty-input">
